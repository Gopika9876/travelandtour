		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
                    ...
                    <select name="sort">
                         <option class="section_subtitle" value=" "> select</option>
				...
				<div class="col">
					<div class="destinations_container item_grid">
                                           ...
                                           session.setAttribute("cost1",cost);
                                                ...
                                                String sql="select * from package where place='"+city+"' and cost<'"+cost+"'";
...
%>
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="details.jsp?id=<%=rs.getString(1)%>"><%=rs.getString(2)%></a></div>
								<div class="destination_subtitle"><p><%=rs.getString(3)%></p></div>
								<div class="destination_price">From <%=rs.getString(7)%></div>
							</div>
						</div>
                                                <%
                                                }
