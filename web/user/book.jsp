<%@include file="header.jsp" %>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="contact_form_container">
						<form action="book_act.jsp" method="post" id="contact_form" class="contact_form">
   <select class="contact_input contact_input_name inpt"  name="BankName" required="required">
							...
							<div style="margin-bottom: 18px"><input name="username" type="text" class="contact_input contact_input_name inpt" placeholder="confirm username" required="required"><div class="input_border"></div></div>
                                                        <div style="margin-bottom: 18px"><input name="amount"  value="<% out.println(totalcost);%>" type="text" class="contact_input contact_input_name inpt" placeholder="confirm username" required="required" readonly><div class="input_border"></div></div>
							<div style="margin-bottom: 18px"><input name="id" type="text"  value="<% out.println(id);%>" class="contact_input contact_input_name inpt" placeholder="confirm username" required="required" readonly><div class="input_border"></div></div>
