						...
						<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
							...
							<nav class="main_nav">
								<ul class="d-flex flex-row align-items-start justify-content-start">
									...
									<li><a href="view_package.jsp">Search package</a></li>
									<li><a href="package.jsp">View_package</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_subtitle">simply amazing packages</div>
					<div class="section_title"><h2>Popular Packages</h2></div>
				</div>
			</div>
                    <form method="post" action="rate.jsp">
                    <select name="sort">
                        <option class="section_subtitle" value="low"> price low to high</option>
                            <option class="section_subtitle" value="high">price high to low</option>
                    </select>
			...
			<div class="row destinations_row">
				<div class="col">
					<div class="destinations_container item_grid">
                                            <% 
                                              String city=  session.getAttribute("city1").toString();
                                                String cost=  session.getAttribute("cost1").toString();
                                                out.println(city);
                                                String sql;
                                                  ...
                                                  {
                                                 sql="select * from package where place='"+city+"' and cost<'"+cost+"' order by cost asc";
                                              ...
                                              sql="select * from package where place='"+city+"' and cost<'"+cost+"' order by cost desc";
...
%>
						...
						<div class="destination item">
							<div class="destination_image">
                                                            <img src="../upload/<%=rs.getString(6)%>" alt="">
								<div class="spec_offer text-center"><a href="#">Special Offer</a></div>
							</div>
							<div class="destination_content">
								<div class="destination_title"><a href="destinations.html"><%=rs.getString(2)%></a></div>
								<div class="destination_subtitle"><p><%=rs.getString(3)%></p></div>
								<div class="destination_price"><%=rs.getString(7)%></div>
							</div>
						</div>
                                                <%
                                                }
						...
						<div class="destination item">
							<div class="destination_image">
								<img src="images/destination_malaysia.jpg" alt="">
							</div>
							<div class="destination_content">
